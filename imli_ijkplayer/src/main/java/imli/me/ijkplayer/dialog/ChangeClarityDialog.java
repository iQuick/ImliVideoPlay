package imli.me.ijkplayer.dialog;
...
public class ChangeClarityDialog extends Dialog {
    ...
    private void init(Context context) {
        ...
        windowParams.width = VPUtil.getScreenHeight(context);
        windowParams.height = VPUtil.getScreenWidth(context);
    ...
    public void setClarityGrade(List<String> items, int defaultChecked) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            params.topMargin = (i == 0) ? 0 : VPUtil.dp2px(getContext(), 16f);
