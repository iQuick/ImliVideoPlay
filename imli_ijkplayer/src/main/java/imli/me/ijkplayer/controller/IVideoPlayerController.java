...
public abstract class IVideoPlayerController
     ...
     *                  <ul>
     *                  <li>{@link SimpleVideoPlayer#STATE_IDLE}</li>
     *                  <li>{@link SimpleVideoPlayer#STATE_PREPARING}</li>
     *                  <li>{@link SimpleVideoPlayer#STATE_PREPARED}</li>
     *                  <li>{@link SimpleVideoPlayer#STATE_PLAYING}</li>
     *                  <li>{@link SimpleVideoPlayer#STATE_PAUSED}</li>
     *                  <li>{@link SimpleVideoPlayer#STATE_BUFFERING_PLAYING}</li>
     *                  <li>{@link SimpleVideoPlayer#STATE_BUFFERING_PAUSED}</li>
     *                  <li>{@link SimpleVideoPlayer#STATE_ERROR}</li>
     *                  <li>{@link SimpleVideoPlayer#STATE_COMPLETED}</li>
     *                  </ul>
     */
     ...
     *                 <ul>
     *                 <li>{@link SimpleVideoPlayer#MODE_NORMAL}</li>
     *                 <li>{@link SimpleVideoPlayer#MODE_FULL_SCREEN}</li>
     *                 <li>{@link SimpleVideoPlayer#MODE_TINY_WINDOW}</li>
     *                 </ul>
     */
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!mNeedChangePosition && !mNeedChangeVolume && !mNeedChangeBrightness) {
                    ...
                    if (absDeltaX >= THRESHOLD) {
                        ...
                        if (mDownX < getWidth() * 0.5f) {
                            ...
                            mGestureDownBrightness = VPUtil.scanForActivity(mContext)
                ...
                if (mNeedChangeBrightness) {
                    ...
                    WindowManager.LayoutParams params = VPUtil.scanForActivity(mContext)
                            .getWindow().getAttributes();
                    params.screenBrightness = newBrightnessPercentage;
                    VPUtil.scanForActivity(mContext).getWindow().setAttributes(params);
